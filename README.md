...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=AdiThorat-eth&theme=radical&no-frame=true&no-bg=false&margin-w=4&row=2&column=4" />
</div>

<div align="center">
  
| Trophy Category | Achievement | Status |
|----------------|-------------|--------|
| 🏆 **Commits** | Regular Contributor | Active |
| 📚 **Experience** | Intermediate Developer | Growing |
| 📁 **Repositories** | Project Creator | Building |
| ⭐ **Stars** | Quality Code | Improving |
| 👥 **Followers** | Community Member | Connecting |
| 🐛 **Issues** | Problem Solver | Contributing |
| 🔄 **Pull Requests** | Collaborator | Learning |
| 📝 **Reviews** | Code Reviewer | Developing |
